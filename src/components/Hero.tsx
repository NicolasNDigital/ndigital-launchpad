...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-20 pb-32 bg-gradient-to-b from-deep-black via-deep-black/95 to-electric-blue/20">
