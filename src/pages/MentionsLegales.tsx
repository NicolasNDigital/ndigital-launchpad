        ...
        <div className="prose prose-invert prose-lg max-w-none space-y-8">
          <section>
            ...
            <p className="text-white/70">
              Le site <strong className="text-white">ndigital-pro.fr</strong> est édité par l'entreprise <strong className="text-white">NDigital - Nicolas SCHUBLIN</strong>.
            </p>
            <ul className="text-white/70 list-none space-y-2 mt-4">
              <li><strong className="text-white">Statut :</strong> Micro-entreprise</li>
              <li><strong className="text-white">Siège social :</strong> 4 rue du Muguet, 68720 HOCHSTATT</li>
              ...
              <li><strong className="text-white">Email :</strong> contact@ndigital-pro.fr</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-white/70">
              Monsieur <strong className="text-white">Nicolas SCHUBLIN</strong>.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-white/70">
              Ce site est hébergé par la société <strong className="text-white">GitHub Inc.</strong>, située au 88 Colin P. Kelly Jr. St, San Francisco, CA 94107, USA.
            </p>
            <p className="text-white/70 mt-2">
              Le nom de domaine est enregistré auprès de la société <strong className="text-white">OVH SAS</strong>.
            </p>
          </section>
